...
CREATE TABLE products (
  ...
  target_customer VARCHAR(200) DEFAULT '',
...
CREATE TABLE pipeline (
  ...
  stage VARCHAR(20) DEFAULT 'lead' CHECK (stage IN ('lead', 'interested', 'quoted', 'negotiating', 'closed')),
  amount DECIMAL(12,2) DEFAULT 0,
  probability DECIMAL(5,2) DEFAULT 0,
  expected_close VARCHAR(7) DEFAULT '',
  notes TEXT DEFAULT '',
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE leads (
  ...
  score INTEGER DEFAULT 0,
  status VARCHAR(20) DEFAULT 'pending' CHECK (status IN ('pending', 'qualified', 'contacted', 'converted')),
  industry VARCHAR(100) DEFAULT '',
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
